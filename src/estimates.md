...
<aside class="toast-position">
  <div class="toast">
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
    <span>Estimate #123 has been approved.</span>
  </div>
</aside>
...
<main>
  <div class="flex justify-space-between">
    ...
    <div class="flex">
      ...
      <input class="input search show-desktop" type="text" placeholder="Find an estimate…">
    </div>
  </div>
  ...
  <div class="tabs mt-16 mb-16">
    <nav>
      ...
      <a href="#">Saved view</a>
      <a href="#" class="is-selected">All estimates</a>
    </nav>
  </div>
