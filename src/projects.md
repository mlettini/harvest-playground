...
<main>
  ...
  <div class="tabs mt-24 mb-16">
    <nav>
      <a href="#" class="is-selected">Active (50)</a>
      <a href="#">Pinned (12)</a>
      <a href="#">Budgeted (42)</a>
      <a href="#">Templates (2)</a>
      <a href="#">Stale (23)</a>
      <a href="#">Archived</a>
    </nav>
  </div>
    ...
    <table border="0" class="table" cellpadding="0" cellspacing="0">
      ...
      <tbody>
        <tr>
          ...
          <td class="nowrap">
            <div class="mb-4">
              <small class="text-secondary">Client name</small><br>
