...
<main>
  ...
  <div class="tabs mt-24 mb-16">
    <nav>
      <a href="#" class="is-selected">Active (6)</a>
      <a href="#">Pinned (0)</a>
      <a href="#">Archived</a>
    </nav>
  </div>
    ...
    <table border="0" class="table" cellpadding="0" cellspacing="0">
      ...
      <tbody>
        <tr>
          ...
          <td class="no-width"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg></td>
          <td>
